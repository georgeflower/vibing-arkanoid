    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6">
          <span
            className="retro-pixel-text text-lg md:text-xl"
            style={{ color: 'hsl(180, 70%, 60%)' }}
          >
        ...
        <div className="text-center mb-6">
          <span
            className="retro-pixel-text text-base md:text-lg"
        ...
        >
          <span
            className="retro-pixel-text text-sm md:text-base animate-pulse"
...
const StatRow = ({ 
  ...
  <div className="flex justify-between items-center">
    <span
      className="retro-pixel-text text-xs md:text-sm"
      style={{ color: 'hsl(0, 0%, 70%)' }}
    >
      {label}:
    </span>
    <span
      className="retro-pixel-text text-sm md:text-base font-bold"
