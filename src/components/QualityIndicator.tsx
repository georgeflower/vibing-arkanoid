...
export const QualityIndicator = ({ quality, autoAdjustEnabled }: QualityIndicatorProps) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 pointer-events-none select-none">
      <div className="flex items-center gap-2 bg-black/70 backdrop-blur-sm px-3 py-2 rounded-lg border border-border/20">
